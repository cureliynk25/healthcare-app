      ...
      <View className="bg-card dark:bg-card-dark p-3.5">
        <View className="flex-row items-center gap-1.5">
          <Text className="text-content dark:text-content-dark font-bold">
            {t("dashboard.pregnancyCare.title")}
          </Text>
        </View>
        <Text className="text-muted dark:text-muted-dark text-xs mt-1">
          {t("dashboard.pregnancyCare.subtitle")}
        </Text>
        <View className="flex-row items-center gap-1 mt-3 self-start bg-pink-50 dark:bg-pink-500/15 rounded-full px-3 py-1.5">
          <Text className="text-pink-700 dark:text-pink-300 text-xs font-semibold">
            {t("common.explore")}
          </Text>
          <Ionicons name="arrow-forward" size={12} color={colors.accentPink} />
        </View>
      </View>
    </TouchableOpacity>
  );
